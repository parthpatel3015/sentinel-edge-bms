...
void printBMSData() {
  ...
  if (bms.imbalanceChange >= 0)
    Serial.print("+");

  Serial.print(bms.imbalanceChange, 3);
...
void setup() {
  ...
  Serial.println("Starting automated BMS test...");
  Serial.println();
...
void loop() {
  ...
  if (currentTime - lastTestChange >= TEST_INTERVAL) {
