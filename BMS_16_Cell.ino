...
void setup() {
  ...
  bms.cellVoltage[8]  = 4.09;
  bms.cellVoltage[9]  = 4.10;
  bms.cellVoltage[10] = 4.08;
  bms.cellVoltage[11] = 4.11;

  bms.cellVoltage[12] = 4.06;
  bms.cellVoltage[13] = 4.09;
  bms.cellVoltage[14] = 4.07;
  bms.cellVoltage[15] = 4.05;
